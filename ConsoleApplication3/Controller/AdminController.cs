    ...
    public class AdminController
    {
        ...
        public void UserList(int i, Account account, int currentPage = 1)
        {
            ...
            Console.WriteLine(
                "------------------------------------------------------------------------------------------------------------------------------------");
            Console.WriteLine(
                "ID | AccountNumber | Balance | Username | PasswordHash | Salt | Fullname | Email | PhoneNumber | Role | Status | createAt | updateAt");
            Console.WriteLine(
                "------------------------------------------------------------------------------------------------------------------------------------");
            try
            {
        ...
        public void TransactionHistory(int i, Account account, int currentPage = 1)
        {
            ...
            Console.WriteLine(
                "------------------------------------------------------------------------------------------------------------------------------");
            Console.WriteLine(
                "AccountNumber | SenderAccountNumber | ReceiverAccountNumber | Amount | Fee | Message | createAt | updateAt | TransactionStatus");
            Console.WriteLine(
                "------------------------------------------------------------------------------------------------------------------------------");
            try
            {
        ...
        {
            Console.WriteLine("Vui lòng nhập vào tên đầy đủ bạn muốn tìm kiếm");
        ...
        {
            Console.WriteLine("Vui lòng nhập vào số tài khoản bạn muốn tìm kiếm");
        ...
        public void LockOpenAccount(Account account)
        {
            try
            {
                Console.WriteLine("Nhập vào số tài khoản của tài khoản bạn muốn thay đổi");
                var AccountNumber = Console.ReadLine();
        ...
        public void ChangePass(Account account)
        {
            ...
            Console.WriteLine("Nhập vào số tài khoản của tài khoản bạn muốn thay mật khẩu");
